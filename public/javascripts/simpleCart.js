		...
		generateSimpleCart = function (space) {
			...
			var selectorEngines = {
				...
				currencies = {
					...
					"RMB": { code: "RMB", symbol: "&yen;", name: "Chinese RMB", accuracy: 2},
				...
				settings = {
					...
					cartColumns			: [
      					{attr : "name", label : "名称"},
      					{view : "image", label : "图片", attr : "image"},
			...
			simpleCart.extend({
				...
				showlist: function () {
					...
					// get all the items
					simpleCart.each(function (item) {
						items.push(simpleCart.extend(item.fields(), item.options()));
					});
				...
				loaddb: function() {
					...
					$.ajax({
						...
						success : function(data){
							var items = [];
							var number = data[0].item_number;
							//var name = "item_name_" + 1;
							//alert(data[0][name]);
							for(var i = 1; i <= number; i++){
								var item_name = data[0]["item_name_" + i];
								var item_quantity = data[0]["item_quantity_" + i];
								var item_price = data[0]["item_price_" + i];
								var item_image = data[0]["item_image_" + i];
								var content = {
										"id" : item_name,
										"name" : item_name,
			...
			simpleCart.Item._ = simpleCart.Item.prototype = {
				...
				reservedFields: function () {
					return ['quantity', 'id', 'item_number', 'price', 'name', 'shipping', 'tax', 'taxRate' , 'image'];
				},
